# Generated by Django 4.2 on 2024-11-22 20:38
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "owner",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name="Клиент"
                    ),
                ),
                (
                    "table",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="booking_app.table", verbose_name="Стол"
                    ),
                ),
            ],
        ),
